            ...
            isAdmin ? (
              <div className="px-6 pb-6 md:px-8 md:pb-8 border-t border-slate-100 text-slate-650 space-y-3.5 text-[13px] md:text-sm leading-relaxed text-justify animate-in fade-in slide-in-from-top-2 duration-350">
                ...
                <ul className="list-disc pl-5 space-y-2.5 text-slate-600">
                  ...
                  <li>
                    <strong className="text-slate-800">Metrik Evaluasi & Tingkat Kepercayaan:</strong> Performa model diukur menggunakan metrik <em className="italic">Mean Absolute Percentage Error</em> (MAPE) terakumulasi dari seluruh fold validasi. Indikator <strong className="text-slate-800">Tingkat Kepercayaan (Confidence Score)</strong> yang ditampilkan di dashboard (misalnya 99.2%) dihitung secara langsung dengan formula <code className="px-1.5 py-0.5 bg-slate-100 rounded text-purple-700 font-bold text-[11px]">100% - MAPE</code>.
                    <p className="mt-1.5 text-slate-500 italic text-[11px] leading-relaxed">
                      *Catatan Metodologi: Tingkat Kepercayaan ini diukur dari rata-rata performa peramalan out-of-sample pada sampel uji lintas 4 periode validasi (n &approx; 43 observasi bulanan), sehingga nilai akurasi tetap stabil dan konsisten sepanjang tahun.
                    </p>
                  </li>
                  <li>
