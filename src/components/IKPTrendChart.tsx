...
export default function IKPTrendChart({ ikpData = [], selectedYear }: IKPTrendChartProps) {
  ...
  return (
    <div className="dashboard-card border-none shadow-sm bg-white p-4 rounded-xl flex flex-col h-full min-h-[260px] justify-between">
      ...
      {/* Info Warning Footnote */}
      <div className="mt-2.5 p-2 bg-amber-50 rounded-lg border border-amber-100 text-[9px] text-amber-900 font-bold leading-normal">
        ⚠️ **Catatan Metodologi**: Tahun 2025 menggunakan metodologi baru (12 indikator) sehingga tidak sepenuhnya sebanding dengan seri 2021–2024. Penurunan target nasional tidak dapat diartikan secara langsung sebagai penurunan kinerja.
      </div>
    </div>
  );
}
