...
export default function PPHGauge({ value = 88.1 }: PPHGaugeProps) {
  ...
  return (
    <div ref={setElementRef} className="relative flex flex-col h-full bg-gradient-to-br from-[#059669] via-[#6EE7B7]/45 to-white/95 p-4 rounded-xl shadow-md border border-emerald-200/50 items-center justify-between group select-none">
      ...
      <div className="relative w-full flex flex-col items-center justify-center pt-2">
        <div className="relative w-36 h-18 overflow-hidden">
          <svg className="w-full h-full" viewBox="0 0 100 50">
            ...
            {/* Green Progress Arc */}
            <path d={getArcPath(animatedValue)} fill="none" stroke="#047857" strokeWidth="8" strokeLinecap="round" />
