...
export default function KetersediaanEnergiGauge({ value = 2582 }: KetersediaanEnergiGaugeProps) {
  ...
  if (value > 2400) {
    ...
    statusTitle = 'Sedang';
    statusDesc = 'Ketersediaan energi pangan berada di sekitar tingkat kebutuhan standar, menunjukkan kecukupan pasokan relatif terpenuhi namun masih memerlukan penjagaan stabilitas produksi, distribution, atau akses pangan.';
          ...
          <div className="bg-white rounded-2xl shadow-2xl border border-slate-100 max-w-md w-full overflow-hidden animate-in fade-in zoom-in-95 duration-200 text-left" onClick={(e) => e.stopPropagation()}>
             ...
             <div className="p-6 space-y-4">
                <div className="flex items-center gap-2.5">
                   ...
                   <div>
                      <h4 className="text-xs font-black text-slate-800 leading-none">Ketersediaan Energi</h4>
                      <span className="text-[10px] font-bold text-slate-400 mt-1 block">STATISTIK LOGISTIK KALORI</span>
                   </div>
                </div>
